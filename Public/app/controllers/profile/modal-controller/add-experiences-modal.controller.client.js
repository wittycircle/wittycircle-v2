 ...
 */
angular.module('wittyApp').controller('AddExperiencesModalCtrl', function ($modalInstance, $filter, $http, $location, $scope, Profile, $rootScope, $stateParams, Experiences, Skills, Interests, Locations) {
