 ...
 */
angular.module('wittyApp').controller('SignupCtrl', function ($http, $cookieStore, Upload, $filter, $stateParams, $location, $scope, $timeout, $rootScope, Authentication, Data_auth, Skills, Interests, Experiences, Locations) {
  ...
  String.prototype.capitalizeFirstLetter = function() {
    ...
    var clone = $('#header-section').detach();
